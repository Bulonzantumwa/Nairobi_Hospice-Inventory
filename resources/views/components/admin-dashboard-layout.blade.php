...
<html lang="en">
@php
    $siteInfo = \App\Models\SiteIdentity::first();
@endphp
<head>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
    <title> {{ $siteInfo->siteName ?? 'Default Site Title' }}</title>
    <link
        href="https://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400;600;700;900&display=swap"
        rel="stylesheet"
    />
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <link rel="stylesheet" href="{{ asset('themebuild/css/tailwind.css') }}"/>
    <script
                    ...
                    >
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        ...
                        <div role="menu" x-show="open" class="mt-2 space-y-2 px-7" aria-label="Dashboards">
                            ...
                            @role('super_admin')
                            <a
                                href="{{ route('superAdmin.siteIdentity.index') }}"
                                role="menuitem"
                    ...
                    >
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        ...
                        <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                            ...
                            <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                            <a
                                href="{{ route('superAdmin.condition.index') }}"
                                role="menuitem"
                            ...
                            <a
                                href="{{ route('superAdmin.utility.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Utility
                            ...
                            <a
                                href="{{ route('superAdmin.location.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
                            >
                                Location
                  ...
                  <span aria-hidden="true">
                    ...
                    >
                      ...
                      />
                            ...
                            <span class="ml-2 text-sm"> Requisition </span>
                            <span aria-hidden="true" class="ml-auto">
                    <!-- active class 'rotate-180' -->
                    <svg
                        class="w-4 h-4 transition-transform transform"
                    ...
                    >
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        ...
                        <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Pages">
                            ...
                            <a
                                href="{{ route('hod.requisitionForm.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Requisition Form
                            ...
                            <a
                                href="{{ route('financeOfficer.requisitionForm.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Requisition Form
                            ...
                            <a
                                href="{{ route('ceo.requisitionForm.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Requisition Form
                            ...
                            @role('finance_officer')
                            <a
                                href="{{ route('financeOfficer.ceoForm.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Approved Requisitions
                    ...
                    >
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        ...
                        <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Pages">
                            ...
                            @role('head_of_department')
                            <a
                                href="{{ route('hod.clinicalInventory.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                General Inventory
                            ...
                            @role('finance_officer')
                            <a
                                href="{{ route('financeOfficer.clinicInventory.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                General Inventory
                            ...
                            @role('chief_executive_officer')
                            <a
                                href="{{ route('ceo.clinicInventory.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                General Inventory
                            ...
                            @role('super_admin')
                            <a
                                href="{{ route('superAdmin.clinicInventory.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                General Inventory
                            ...
                            @role('head_of_department')
                            <a
                                href="{{ route('hod.itemsRent.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Rented Equipments
                            ...
                            @role('finance_officer')
                            <a
                                href="{{ route('financeOfficer.itemsRent.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Rented Equipments
                            ...
                            @role('chief_executive_officer')
                            <a
                                href="{{ route('ceo.itemsRent.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Rented Equipments
                            ...
                            @role('super_admin')
                            <a
                                href="{{ route('superAdmin.itemsRent.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Rented Equipments
                            ...
                            @role('finance_officer')
                            <a
                                href="{{ route('financeOfficer.drugList.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Drug List
                            ...
                            @role('super_admin')
                            <a
                                href="{{ route('superAdmin.drugList.index') }}"
                                role="menuitem"
                                class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                            >
                                Drug List
                    ...
                    >
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a href="{{ route('superAdmin.users.index') }}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">Users</a>
                                <a href="{{ route('superAdmin.roles.index') }}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">Roles</a>
{{--                                <a href="{{ route('superAdmin.permissions.index') }}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">Permissions</a>--}}
                            </div>
                        </div>
                        @endrole
        ...
        <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
            ...
            <header class="relative bg-white dark:bg-darker">
                <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
                  ...
                  >
                    ...
                    >
                        {{ $siteInfo->siteName ?? 'Default Site Name' }}
                    </a>
                    ...
                    <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open; $nextTick(() => { if(open){ $refs.userMenu.focus() } })"
                                    ...
                                    class="flex items-center justify-center transition-opacity duration-200 rounded-full dark:opacity-75 dark:hover:opacity-100 focus:outline-none focus:ring dark:focus:opacity-100"
                            >
                                <span class="sr-only">User menu</span>
                                <div class="flex flex-col items-center">
                                    @if (auth()->user()->getFirstMediaUrl('profile_images'))
                                        <img class="w-10 h-10 rounded-full" src="{{ auth()->user()->getFirstMediaUrl('profile_images') }}" alt="Profile Image">
                                    @else
                                        <div class="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center">
                                            <span class="text-gray-600 text-lg">{{ strtoupper(substr(auth()->user()->name, 0, 1)) }}</span>
                                        </div>
                                    @endif
                      ...
                      >
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                            ...
                            <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                                ...
                                <a href="auth/register.html" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">Register</a>
            ...
            @if(Session::has('message'))
                <div class="bg-indigo-900 text-center py-4 lg:px-4" x-data="{open: true}" x-show="open">
...
{{--            >--}}
{{--                <div>{{ $siteInfo->siteName ?? 'Default Site Name' }} &copy; {{ \Carbon\Carbon::now()->format('Y') }}</div>--}}
{{--                <div>--}}
{{--                    Made by--}}
                      ...
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        ...
                        />
                                ...
                                <div class="flex-1 overflow-hidden">
                                    ...
                                    <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                                        Shared new project "H-Inventory Dashboard"
                                    </p>
                                    <span
                      ...
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        ...
                        />
                                ...
                                <div class="flex-1 overflow-hidden">
                                    ...
                                    <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                                        Commit new changes to H-Inventory Dashboard project.
                                    </p>
                                    <span
                      ...
                      <span class="relative z-10 inline-block overflow-visible rounded-ful">
                        ...
                        />
                                ...
                                <div class="flex-1 overflow-hidden">
                                    <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Ahmed Kamel</h5>
                                    <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                                        Release new version "H-Inventory Dashboard"
                                    </p>
                                    <span
            ...
            <div class="flex flex-col h-screen">
              ...
              <span class="absolute inset-y-0 inline-flex items-center px-4">
                ...
                <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
                    ...
                    <a href="#" class="flex space-x-4">
                        <div class="flex-shrink-0">
                            <img class="w-10 h-10 rounded-lg" src="build/images/cover-2.jpg" alt="H-Inventory Dashboard"/>
                        </div>
                        <div class="flex-1 max-w-xs overflow-hidden">
                            <h4 class="text-sm font-semibold text-gray-600 dark:text-light">H-Inventory Dashboard</h4>
                            <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                    ...
                    <template x-for="i in 10" x-key="i">
                        <a href="#" class="flex space-x-4">
                            <div class="flex-shrink-0">
                                <img class="w-10 h-10 rounded-lg" src="{{ asset('themebuild/images/cover-3.jpg') }}" alt="H-Inventory Dashboard"/>
                            </div>
                            <div class="flex-1 max-w-xs overflow-hidden">
                                <h4 class="text-sm font-semibold text-gray-600 dark:text-light">H-Inventory Dashboard</h4>
                                <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
...
<script src="{{ asset('themebuild/js/script.js') }}"></script>
<script>
    const setup = () => {
        const getTheme = () => {
