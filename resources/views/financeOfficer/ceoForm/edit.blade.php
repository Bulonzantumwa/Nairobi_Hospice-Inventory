            ...
            <div class="mt-2 w-3/4 justify-center mx-auto">
                <div class="flex flex-wrap items-center mb-6">
                    <div class="w-full md:w-1/2 px-2 flex items-center justify-end">
                        <a href="{{ route('financeOfficer.ceoForm.index') }}" class="px-4 py-2 text-sm text-white rounded-md bg-primary hover:bg-primary-dark focus:outline-none focus:ring focus:ring-primary focus:ring-offset-1 focus:ring-offset-white dark:focus:ring-offset-dark">
